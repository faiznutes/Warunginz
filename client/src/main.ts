...
window.console.warn = (...args: any[]) => {
  ...
  if (message.includes('CORS') ||
    message.includes('Access-Control') ||
    message.includes('Banner not shown: beforeinstallpromptevent.preventDefault() called.') ||
    message.includes('The page must call beforeinstallpromptevent.prompt() to show the banner.') ||
