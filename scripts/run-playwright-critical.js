...
const COMMAND =
  "npx playwright test tests/playwright/critical-role-access.spec.ts --workers=1 --reporter=json";
...
console.log(
  `Playwright critical summary: total=${summary.total}, passed=${summary.passed}, failed=${summary.failed}, skipped=${summary.skipped}`,
);
